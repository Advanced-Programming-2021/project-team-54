...
public class Player {
    ...
    public Player(String name, String password, int score, String nickname, int money, int profilePictureID) {
        this.username = name;
    ...
    public static boolean createPlayerJsonFile(Player player) {
        ...
        playerDetails.put("profilePictureID", player.profilePictureID + "");
    ...
    public static Player getPlayerByUsername(String username) {
        ...
        try (FileReader fileReader = new FileReader(usersFile)) {
            ...
            int profilePictureID = Integer.parseInt((String) jsonObject.get("profilePictureID"));
            Player player = new Player(name, password, score, nickname, money, profilePictureID);
    ...
    public void changeProfilePicture() {
        ...
        profilePictureID = random.nextInt(38);
        updateInJsonFile();
    }
